...
reported to the project maintainers by opening an issue, or, if the report
itself is sensitive, via a
[private security advisory](https://github.com/mixa12344321/splitvpn/security/advisories/new)
(it's the only private-by-default reporting channel this repository has
set up; the "security" label is fine for a conduct report too). All
